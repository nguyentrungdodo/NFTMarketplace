            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="intro d-flex justify-content-between align-items-end m-0">
                        ...
                        <div class="intro-btn">
                            <a class="btn content-btn" href="/explore-two">Explore More</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-caption col-12 p-0">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-bordered-white btn-smaller mt-3" href="wallet-connect"><i class="icon-handbag mr-2"></i>Place a Bid</a>
                            </div>
                        </div>
                    </div>
                </div>
